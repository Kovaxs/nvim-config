...
keymap.set("n", "<leader>fo", require("telescope.builtin").lsp_document_symbols, {
	desc = "Opens a Telescope prompt to search and navigate symbols within the current document using Language Server Protocol (LSP) integration.",
...
keymap.set("n", "<leader>fm", function()
	...
	desc = "This custom function utilizes Telescope's treesitter provider and sets the default text to 'method:', likely used for finding and selecting methods within your code.",
