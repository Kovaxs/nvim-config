...
keymap.set("n", "<leader>ba", function()
	...
	vim.fn.setqflist(require("dap.breakpoints").to_qf_list(breakpoints), "r")
	Snacks.picker.qflist()
...
end, { desc = "Shows diagnostics filtered to errors" })
keymap.set("n", "<leader>df", function()
	local widgets = require("dap.ui.widgets")
	widgets.centered_float(widgets.frames)
end, { desc = "Lists stack frames" })
keymap.set("n", "<leader>dh", function()
	require("dap.repl").open()
	require("dap.repl").execute(".help")
end, { desc = "Lists DAP commands" })
