...
keymap.set("n", "<leader>dj", "<cmd>lua require'dap'.step_over()<cr>", {desc = "Steps over the current line (without entering functions)"})
keymap.set("n", "<leader>dk", "<cmd>lua require'dap'.step_into()<cr>", {desc = "Steps into the function call at the current line"})
keymap.set("n", "<leader>dl", "<cmd>lua require'dap'.run_last()<cr>", {desc = "Re-runs the last debug configuration"})
keymap.set("n", "<leader>do", "<cmd>lua require'dap'.step_out()<cr>", {desc = "Steps into the function call at the current line"})
